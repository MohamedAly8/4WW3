...
<!-- Second input name Validation: Required Field-->
...
<div class="form-row col-md-10">
  ...
  <div id="map"></div>
  <script
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAaFaKoNyutetKrN8ff443jORcMCvqAsHA&callback=initMap&libraries=&v=weekly"
  async
></script>      
